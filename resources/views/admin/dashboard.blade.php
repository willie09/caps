<x-app-layout>
    ...
    <div class="relative z-10 rounded-xl py-8">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Total Sales -->
                <div class="bg-gradient-to-r from-green-500 to-green-600 overflow-hidden shadow-lg sm:rounded-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">P{{ number_format($totalSales, 2) }}</p>
                        </div>
                    </div>
                </div>

                <!-- Total Expenses -->
                <div class="bg-gradient-to-r from-red-500 to-red-600 overflow-hidden shadow-lg sm:rounded-lg p-6 text-white">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">P{{ number_format($totalExpenses, 2) }}</p>
                        </div>
                    </div>
                </div>

                <!-- Net Worth -->
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 overflow-hidden shadow-lg sm:rounded-lg p-6 text-white">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">P{{ number_format($netWorth, 2) }}</p>
                        </div>
                    </div>
                </div>

                <!-- Total Members -->
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 overflow-hidden shadow-lg sm:rounded-lg p-6 text-white">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-indigo-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ $totalTrainors }}</p>
                        </div>
                    </div>
                </div>
            ...
            <!-- Charts Section -->
            <div class="bg-white dark:bg-gray-800 mt-6 overflow-hidden shadow-sm sm:rounded-lg p-6">
