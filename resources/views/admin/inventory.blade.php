                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-sm font-medium space-x-2">
                                    <button onclick="openProductEditModal({{ $product->id }}, '{{ $product->product_name }}', {{ $product->quantity }}, {{ $product->selling_price }}, {{ $product->amount_sold }}, '{{ $product->image }}')" class="text-indigo-600 hover:text-indigo-900">Edit</button>
