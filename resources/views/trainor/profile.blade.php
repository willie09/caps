            ...
            <div class="glass-effect border border-white/20 rounded-2xl shadow-xl overflow-hidden max-w-4xl mx-auto">
                ...
                <div class="bg-gradient-to-r from-purple-500 to-pink-500 p-8">
                    <div class="flex items-center space-x-6">
                        <!-- Profile Image -->
                        <div class="w-24 h-24 rounded-full flex items-center justify-center shadow-lg overflow-hidden">
                        ...
                        <!-- Name -->
                        <div class="flex-1">
                            <h1 class="text-2xl sm:text-3xl font-bold text-white">{{ $trainor->name }}</h1>
                        </div>

                        <!-- Edit Button -->
                        <div class="flex-shrink-0">
                            <button onclick="openEditModal()" class="bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 border border-white/30">
                        ...
                        <div class="p-8">
                            ...
                            <form method="POST" action="{{ route('trainor.profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                                ...
                                <div class="flex items-center gap-4 pt-4">
                                    <button type="button" onclick="closeEditModal()" class="bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 border border-white/20">
                                        Cancel
                                    </button>
